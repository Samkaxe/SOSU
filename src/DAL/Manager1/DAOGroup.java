...
public class DAOGroup {
    ...
    public List<Group> getAllGroups(Connection con,int schoolId) throws DalException{
        ...
        try{
            ...
            while(rs.next()){
                ...
                Group group = new Group(id , name , getUsersInGroup(con,id) , schoolID);
    ...
    public Group createGroup(Connection con,Group group)throws DalException {
        try{
    ...
    public void updateGroup(Connection con, Group group)throws DalException {
        try{
    ...
    public void deleteGroup(Connection con,Group group) throws DalException{
        try{
    ...
    public List<User> getUsersInGroup(Connection con , int id) throws DalException {
    ...
    public void addUsertoGroup(Connection con,Group group, User user) throws DalException {
        try{
    ...
    public void removeUserFromGroup(Connection con,User user) throws DalException {
        try {
    ...
    public void removeUserAndGroup(Connection con,User user , Group group)throws DalException{
        try{
